...
import { Upload, Feather, ArrowRight, Check, Eye, EyeOff } from 'lucide-react'
import { supabase } from '../../lib/supabase'

const STEPS = ['Account', 'Identity', 'Your Art', 'Manifesto', 'Submit']
    ...
    return (
      <div className="page-enter min-h-screen flex items-center justify-center px-4 pt-16">
        <div className="text-center max-w-md">
          ...
          <p className="font-display text-lg font-light italic mb-4" style={{ color: 'rgba(234,230,242,0.4)' }}>
            Welcome to the sanctuary, {form.name}.
          </p>
          <p className="text-sm mb-8" style={{ color: 'rgba(234,230,242,0.3)' }}>
            Please check your email to confirm your account. Your passport application will be reviewed within 48 hours.
          </p>
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="font-display font-light mb-3"
            style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: 'var(--ghost)' }}>
            Apply for Your<br />
            <em className="italic" style={{ color: 'var(--cyan)' }}>Artist Passport</em>
          </h1>
          <p className="font-display font-light italic"
            style={{ color: 'rgba(234,230,242,0.38)', fontSize: '1.05rem' }}>
            One form. One piece. Your place in the sanctuary.
          </p>
        </div>
          ...
          {STEPS.map((s, i) => (
            <div key={s} className="flex items-center gap-1 flex-1">
              <div className="flex flex-col items-center">
                <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-light transition-all duration-400"
                  style={{
                ...
                <p className="text-xs mt-1 tracking-wider hidden sm:block"
                  style={{ color: i === step ? 'var(--cyan)' : 'rgba(234,230,242,0.2)', fontSize: '0.6rem' }}>{s}</p>
              </div>
              {i < STEPS.length - 1 && (
        ...
        <div className="rounded-sm p-7" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
          ...
          {step === 0 && (
            <div className="space-y-4">
              <h2 className="font-display text-2xl font-light mb-5" style={{ color: 'var(--ghost)' }}>
                Create your account
              </h2>
              <div>
              ...
              <p className="text-xs" style={{ color: 'rgba(234,230,242,0.25)' }}>
                Already have an account? <a href="/login" style={{ color: 'var(--cyan)' }}>Sign in here</a>
              </p>
            </div>
          )}
          ...
          {step === 2 && (
            <div>
              ...
              <div className="rounded-sm p-10 text-center cursor-pointer transition-all duration-300 mb-5"
                style={{
                ...
                {file ? (
                  ...
                  <div>
                    ...
                    <p className="font-display text-lg font-light" style={{ color: 'rgba(234,230,242,0.5)' }}>
          ...
          {step === 3 && (
            <div>
              <h2 className="font-display text-2xl font-light mb-2" style={{ color: 'var(--ghost)' }}>Your manifesto.</h2>
              <p className="text-sm mb-6" style={{ color: 'rgba(234,230,242,0.3)' }}>What drives your hand?</p>
              <textarea className="input-sacred resize-none" style={{ minHeight: '160px', lineHeight: '1.7' }}
          ...
          {step === 4 && (
            <div className="text-center">
              ...
              <p className="text-sm mb-6" style={{ color: 'rgba(234,230,242,0.35)' }}>
                Reviewed within 48 hours. Check your email to confirm your account.
              </p>
          ...
          <div className="flex justify-between mt-8 pt-5" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            {step > 0 ? (
              <button type="button" onClick={() => setStep(s => s - 1)} className="btn-velvet">
                <span>Back</span>
              </button>
            ) : <div />}
            {step < 4 ? (
              <button type="button" onClick={() => setStep(s => s + 1)} className="btn-ember">
                <span>Continue</span>
                <ArrowRight size={13} />
              </button>
            ) : (
              <button type="button" onClick={handleSubmit} disabled={loading} className="btn-ember"
