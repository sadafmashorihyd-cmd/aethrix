...
export default function ArtistsPage() {
  ...
  const COLORS = ['#00E5FF', '#B57BFF', '#FF6B35', '#FF4444', '#00B8D4']
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-sm mt-2" style={{ color: 'rgba(234,230,242,0.3)' }}>
              {filtered.length} verified artists
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-28">
            ...
            <p className="font-display text-2xl font-light" style={{ color: 'rgba(234,230,242,0.25)' }}>No artists yet.</p>
          </div>
        ) : (
            ...
            {filtered.map((artist, i) => {
              ...
              return (
                <a key={artist.id} href={`/artist/${artist.username}`}
                  ...
                  <div className="flex items-center justify-end pt-3 mt-3" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
